 ...
 * Date: 2018/6/6 下午6:16
 * ModifyTime: 下午6:16
 * Description:
 * https://github.com/Chen-Sir/ExpandableTextView/blob/master/expandabletextview/src/main/java/me/chensir/expandabletextview/ExpandableTextView.java
 */
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.xmly_expandabletextview, this, true);
        ...
        if (mExpandDrawable == null) {
            mExpandDrawable = getDrawable(getContext(), R.drawable.xmly_ic_expand_more_black_12dp);
        }
        if (mCollapseDrawable == null) {
            mCollapseDrawable = getDrawable(getContext(), R.drawable.xmly_ic_expand_less_black_12dp);
        }
