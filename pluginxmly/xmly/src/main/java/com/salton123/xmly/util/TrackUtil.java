...
public class TrackUtil {
    ...
    public static void saveTrackList(List<Track> tracks) {
        ...
        Paper.book().write(XmlyParams.FLAG_PLAY_LIST, trackString);
    }

    public static List<Track> loadTrackList() {
        //TODO
        String trackString = Paper.book().read(XmlyParams.FLAG_PLAY_LIST);
        return new Gson().fromJson(trackString, new TypeToken<List<Track>>() {
        }.getType());
    }
    ...
    public static void saveTrackIndex(int index) {
        Paper.book().write(XmlyParams.FLAG_PLAY_INDEX, index);
    }

    public static int getTrackIndex() {
        return Paper.book().<Integer>read(XmlyParams.FLAG_PLAY_INDEX);
    }
