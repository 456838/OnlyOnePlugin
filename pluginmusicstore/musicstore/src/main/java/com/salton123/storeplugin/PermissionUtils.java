...
public class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(ApplicationBase.getInstance().getPackageName());
    }
    ...
    public static List<String> getPermissions(final String packageName) {
        PackageManager pm = ApplicationBase.getInstance().getPackageManager();
        try {
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(ApplicationBase.getInstance(), permission);
    }
    ...
    public static void launchAppDetailsSettings() {
        ...
        intent.setData(Uri.parse("package:" + ApplicationBase.getInstance().getPackageName()));
        ApplicationBase.getInstance().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(ApplicationBase.getInstance());
    }
